...
const Page: React.FC = () => {
  ...
  return (
    <main>
      ...
      >
        <div className="space-y-6">
          <div className="space-y-1">
            ...
            <div className="rounded-lg bg-orange-100 px-2 py-1 text-slate-700">
              {currentCategoryName}
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            {newCategoryNameError && (
              <div className="flex items-center space-x-1 text-sm font-bold text-rose-500">
                <FontAwesomeIcon
      ...
      <div className="mb-2 text-2xl font-bold text-slate-700">
        既存のカテゴリの一覧
      </div>
      {categories.length === 0 ? (
        <div className="text-gray-500">
            ...
            {categories.map((category) => (
              <div
                ...
                className={twMerge(
                  ...
                  "border border-pink-200 bg-white text-pink-500 shadow-sm hover:shadow-md",
